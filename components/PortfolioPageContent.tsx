...
const portfolioData = {
  ja: [
    {
      id: 1,
      title: "学習院大学 DSA（Distance Scoring Analysis）",
      description: "タンパク質構造解析Webシステム",
      fullDescription:
        "学習院大学における研究プロジェクトとして、タンパク質構造の距離解析を行う DSA（Distance Scoring Analysis） システムの設計・実装を担当しました。従来はローカル環境で行われていた解析フローをWeb上で完結できるよう再構築し、解析のプロセス改善・可視化・再現性の向上を実現しています。研究者が直感的に操作できるUI設計を意識し、解析ジョブの管理、結果の可視化、履歴保存までを一貫して行える構成を採用しました。これにより、研究効率の向上だけでなく、将来的な共同研究や解析手法の展開にも対応可能な基盤として活用されています。",
