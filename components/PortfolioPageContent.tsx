...
const portfolioData = {
  ...
  en: [
    ...
    },
    {
      ...
      image: "/images/スクリーンショット 2026-01-05 2.14.59.png",
      url: "", // プレビューリンクをここに追加
      highlights: [
    ...
    <section className="w-full bg-[#121212] min-h-screen py-12 sm:py-16 md:py-20 lg:py-24">
      <div className="max-w-[1536px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20">
        ...
        <div className="space-y-8 sm:space-y-10 md:space-y-12">
          {/* 1つ目: 横並びブロックスタイル */}
          <div className="group relative overflow-hidden rounded-lg border border-[#2e2e2e] bg-[#171717] transition-all duration-300 hover:border-[#0ABAB5]/30 hover:bg-[#1a1a1a]">
            <div className="flex flex-col lg:flex-row">
              ...
              <div className="w-full lg:w-3/5 p-6 sm:p-8 md:p-10 flex flex-col justify-center">
                <h2 className="text-xl sm:text-2xl md:text-3xl font-medium text-[#fafafa] mb-2 sm:mb-3 transition-colors duration-300 group-hover:text-[#0ABAB5]">
                ...
                {portfolioItems[0].url && (
                  <Link
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 text-sm text-[#0ABAB5] border border-[#0ABAB5]/30 rounded-md hover:bg-[#0ABAB5]/10 transition-colors w-fit"
                  >
          ...
          {/* 2つ目と3つ目: コンパクトグリッドスタイル */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            {portfolioItems.slice(1).map((item) => (
              <div
                key={item.id}
                className="group relative overflow-hidden rounded-lg border border-[#2e2e2e] bg-[#171717] transition-all duration-300 hover:border-[#0ABAB5]/50 hover:bg-[#1a1a1a]"
              >
                {/* 画像エリア */}
                ...
                <div className="p-5 sm:p-6">
                  <h2 className="text-lg sm:text-xl md:text-2xl font-medium text-[#fafafa] mb-2 transition-colors duration-300 group-hover:text-[#0ABAB5]">
                    {item.title}
                  </h2>
                  ...
                  {item.url && (
                    <Link
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 px-3 py-1.5 text-xs sm:text-sm text-[#0ABAB5] border border-[#0ABAB5]/30 rounded-md hover:bg-[#0ABAB5]/10 transition-colors w-fit"
                    >
                      <span>{t.viewSite}</span>
                      <svg
